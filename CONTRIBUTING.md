# Contributing to wcDevs.org AWS Deployer
...
* **Perform a [search](https://github.com/lealceldeiro/org.wcdevs.blog.awsdeployer/labels/bug)** to see if
...
providing the relevant information by filling in
[this form](https://github.com/lealceldeiro/org.wcdevs.blog.awsdeployer/issues/new).
...
* **Perform a [search](https://github.com/lealceldeiro/org.wcdevs.blog.awsdeployer/issues?q=is%3Aopen+label%3Aenhancement%2Cfeature)**
...
[Create an issue](https://github.com/lealceldeiro/org.wcdevs.blog.awsdeployer/issues/new?assignees=lealceldeiro&labels=feature&template=feature_request.yml&title=%5BFeature+Request%5D+)
